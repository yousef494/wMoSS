...
function createBanner(records) {
    var bannerDive = $('<div id="myCarousel" class="carousel slide" data-ride="carousel"></div>').appendTo('#bannerDive');
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        $(itemCon).append('<div class="carousel-caption"><h3>Current <span>Movies</span></h3><p>You can browse for sessions a week in advance</p><a class="hvr-outline-out button2" href="navigate.jsp?status=Current">Shop Now </a></div>');
